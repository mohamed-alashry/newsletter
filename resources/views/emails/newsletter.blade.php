...
<body
  ...
  <![endif]-->
        <table class="es-wrapper" width="100%" cellspacing="0" cellpadding="0"
            style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;padding:0;Margin:0;width:100%;height:100%;background-repeat:repeat;background-position:center top;background-color:#E5E5E5">
            <tr>
                                            ...
                                            <table cellpadding="0" cellspacing="0" width="100%"
                                                ...
                                                <tr>
                                                    <td align="center" valign="top" 
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            role="presentation"
                                                            style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background: url(//ad.net.sa/themes/adtheme/img/animation/Old-Logo.svg);background-size: cover;" background="{{ asset('images/bg-light.png') }}">
                                                            <tr>
                                                                <td align="center" style="padding:0;Margin:0" >
                                                                    <p
                                                ...
                                                <tr>
                                                    <td align="left" style="padding:0;Margin:0;width:371px">
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    style="Margin:0;padding-bottom:5px;padding-left:10px;padding-right:10px;padding-top:20px;font-size:0">
                                            ...
                                            <table cellpadding="0" cellspacing="0" width="100%"
                                                ...
                                                <tr>
                                                    <td align="center" valign="top"
                                                        style="padding:0;Margin:0;width:560px">
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;border-top:1px solid #CCCCCC"
                                                            role="presentation">
                                                            <!--[if !mso]><!-- -->
                                                                ...
                                                                <tr>
                                                                    <td align="center"
                                                                        style="padding:0;Margin:0;position:relative"><a
                                                                            target="_blank" href="{{ $full->link }}"
                                                                            style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#2CB543;font-size:14px"><img
                                                                                class="adapt-img"
                                                                                src="{{ $full->image }}" alt title
                                                                                width="560"
                                                                                style="object-fit: cover;max-height:244px;border-radius:8px 8px 0 0;display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;"></a>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="left"
                                                                            ...
                                                                            <td align="center"
                                                                                ...
                                                                                <a target="_blank"
                                                                                    ...
                                                                                    style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#2CB543;font-size:14px"><img
                                                                                        class="adapt-img"
                                                                                        src="{{ $half->image }}" alt
                                                                                        style="object-fit: cover;max-height:244px;border-radius:8px 8px 0 0;display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"
                                                                                        width="270"></a>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                    ...
                                                    <td align="center" valign="top"
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center" style="padding:0;Margin:0">
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#B1BCC0;font-size:14px">
                                                                        If you prefer not to receive emails like this,
                                                                        you may unsubscribe (c) 2021 ArtPower. All
                                                                        rights reserved.</p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                                            ...
                                                                            <td align="center"
                                                                                ...
                                                                                <a target="_blank"
                                                                                    ...
                                                                                    style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#2CB543;font-size:14px"><img
                                                                                        ...
                                                                                        alt
                                                                                        style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;width:25px !important"></a>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
